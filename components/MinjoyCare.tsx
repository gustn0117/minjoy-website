      ...
      <div className="container-custom">
        ...
        >
          ...
          <div className="absolute inset-0">
            <Image src="/images/care-room-1.jpg" alt="민죠이케어 관리실" fill className="object-cover" />
        ...
        {/* Care Facility Preview */}
        <div
          ref={spaceSection.ref}
          className={`mb-20 scroll-hidden ${spaceSection.isVisible ? 'scroll-visible' : ''}`}
        >
          <div className="text-center mb-10">
            <p className="text-sm text-primary font-medium mb-2">CARE SPACE</p>
            <h3 className="text-3xl font-bold text-gray-900 section-accent">힐링 케어 공간</h3>
          </div>
