        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="text-4xl font-bold text-primary mb-2">-1kg</div>
              <div className="text-sm text-gray-600">1회 체험 평균</div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="text-4xl font-bold text-primary mb-2">+1kg</div>
              <div className="text-sm text-gray-600">근력 증가</div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="text-4xl font-bold text-primary mb-2">-3%</div>
              <div className="text-sm text-gray-600">체지방률 감소</div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="text-4xl font-bold text-primary mb-2">100%</div>
              <div className="text-sm text-gray-600">맞춤 관리</div>
            </div>
          </div>
        </div>
      </div>
